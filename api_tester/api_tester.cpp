...
//
//struct submenu {
//	submenu(std::vector<std::any> input_items, std::tuple<int, int, int, int> hwyx) {
//		menu_items = input_items;
//		menu = newwin(std::get<0>(hwyx), std::get<1>(hwyx), std::get<2>(hwyx), std::get<3>(hwyx));
//	}
...
//template<typename T>
//struct menu_item {
//	menu_item(std::string titel, std::function<void(T)> func , T input) : object(input), title(titel), exec(func) {}
//	std::string title;
//	T object;
...
//};
//template<>
//struct menu_item<void>{
//	menu_item(std::string titel, std::function<void()> func) : title(titel), exec(func) {}
//	std::string title;
...
//	menu_item(std::string titel) : title(titel) {}
//	std::string title;
//	std::function<void()> exec;
//	void go() { exec(); }
//};
...
//
//
//	std::vector<std::any> main_menu{
//		menu_item<client>("Start",[&](client s) {printw(s.ip_address.c_str()); }, client("f", 1, "kys")),
//		menu_item<std::string>("Options",[&](std::string s) {printw(s.c_str()); }, "Hello"),
//		menu_item<void>("Exit",[]() {printw("tester"); }),
//	};
//
//	submenu test(main_menu, {5, 5, 5 ,5});
//	
//	test.show();
//
//	endwin();
...
//	//keypad(stdscr, TRUE);
//
//	//menu_item<std::string> client_execute("Hello");
//	//client_execute.exec = [](std::string s) {std::cout << s << std::endl; };
//	//client_execute.go();
//
